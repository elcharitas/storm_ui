...
class SimpleButton extends StatelessWidget {
  ...
  static void onPressedCallback(
      {SimpleButtonCallback callback: null, eventName: null}) {
    if (callback != null) {
      callback(eventName);
    }
  }
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: ElevatedButton(
          child: this.child,
          onPressed: () => SimpleButton.onPressedCallback(
              callback: this.on, eventName: "pressed"),
          onLongPress: () => SimpleButton.onPressedCallback(
              callback: this.on, eventName: "long-press"),
          onFocusChange: (change) => SimpleButton.onPressedCallback(
              callback: this.on, eventName: "focus"),
          onHover: (change) => SimpleButton.onPressedCallback(
              callback: this.on, eventName: "focus"),
          style: this.style ??
              ButtonStyle(
